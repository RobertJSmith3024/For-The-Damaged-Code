...
struct GameObject
{
	GameObject( int type, Point2D pos, int collisionRadius, int spriteId, int hP);
...
namespace Play
{
	...
	int CreateGameObject( int type, Point2D pos, int collisionRadius, const char* spriteName, int hP );
...
GameObject::GameObject( int type, Point2f newPos, int collisionRadius, int spriteId = 0, int hP = 0 )
	: type( type ), pos( newPos ), radius( collisionRadius ), spriteId( spriteId ), hP ( hP )
{
...
namespace Play
{
	...
	int CreateGameObject( int type, Point2f newPos, int collisionRadius, const char* spriteName, int hP )
	{
		int spriteId = PlayGraphics::Instance().GetSpriteId( spriteName );
		// Deletion is handled in DestroyGameObject()
		GameObject* pObj = new GameObject( type, newPos, collisionRadius, spriteId, hP );
		int id = pObj->GetId();
